...
class Pretrain_Loss(torch.nn.Module):
    def __init__(self, batch_size, args):
        ...
        self.recon_loss_l1 = torch.nn.L1Loss().cuda()
        self.recon_loss_ssim = SSIMLoss().cuda()
    ...
    def __call__(self, output_rot, target_rot, output_contrastive, target_contrastive, output_recons, target_recons):
        ...
        recon_loss = self.alpha3 * (self.recon_lossl1(output_recons, target_recons)+self.recon_loss_ssim(output_recons, target_recons))
